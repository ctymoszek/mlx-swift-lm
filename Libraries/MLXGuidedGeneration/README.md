...
On older OS versions, on Linux, or with any MLX model you load yourself, drive the library directly. Starting from a loaded `ModelContext`, build a grammar constraint from a JSON Schema string and run the guided loop.
